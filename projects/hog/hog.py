...
def roll_dice(num_rolls, dice=six_sided): 
    ...
    while num_rolls > 0:
        ...
        outcomes += point
        num_rolls -= 1    
    return 1 if rolled_one else outcomes
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    if ones_digits == tens_digits:
        ...
        return 3*abs(tens_digits - ones_digits)
    # END PROBLEM 2
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategy_roll(score,opponent_score):
        return n
...
def is_always_roll(strategy, goal=GOAL):
    ...
    "*** YOUR CODE HERE ***"
    flag = True
    roll_times = strategy(0,0)
    for score in range (0,goal):
        for opponent_score in range(0,goal):
            if strategy(score,opponent_score) != roll_times:
                flag = False
                break
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    for nums in range(1,11):
        ...
        average_score = average_dice(nums,dice)
